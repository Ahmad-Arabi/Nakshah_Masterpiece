            ...
            <div class="container-fluid">
              ...
              <div class="position-relative">
                <div class="products-carousel owl-carousel">
                  ...
                  <div class="product-item">
                    <a href="#"><img src="{{ asset('images/product_placeholder.jpg') }}" alt="Product Placeholder"></a>
                    <div class="down-content">
                      <a href="#"><h4>Product Coming Soon</h4></a>
                  ...
                  <div class="category-item">
                    <div class="category-image bg-white">
                      ...
                      <div class="hover-content">
                        <a href="{{ route('shop', ['category' => $category->id]) }}" class="category-btn">Explore {{ $category->name }}</a>
                      </div>
                    </div>
                    <div class="category-title">
                      <h4><a href="{{ route('shop', ['category' => $category->id]) }}" class="category-title-link">{{ $category->name }}</a></h4>
                    </div>
                  </div>
                  @endforeach
                </div>
              ...
              <div class="row services-row">
                <div class="col-md-4">
                  <div class="service-item">
                    ...
                    <p>Upload your own artwork or use our design tools to create personalized products that reflect your unique style. Express yourself through custom text, images, or patterns.</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="service-item">
                    ...
                    <h4>Premium Quality</h4>
                    <p>We use only high-quality materials and advanced printing technologies to ensure your designs look vibrant and last for years. From fabric to print, quality is our promise.</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="service-item">
                    ...
                    <h4>Fast Shipping</h4>
                    <p>Your custom creations are carefully packaged and shipped to your doorstep with reliable tracking. We ensure your items arrive safely and on time, every time.</p>
                  </div>
                </div>
              </div>
